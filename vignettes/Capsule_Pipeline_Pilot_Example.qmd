...
store <- as_capsules(
  ...
  llm_domain = "unknown"   # "unknown" | "always" | "never" (never → no LLM at all)
)
...
With `llm_domain = "never"`, `model` is ignored and no ellmer/LM Studio client is
created (rules / `domain_map` / structure only).
