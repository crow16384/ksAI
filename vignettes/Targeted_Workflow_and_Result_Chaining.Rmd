...
`n_ctx` is set when the model is loaded in LM Studio — not in this call.

**Option A — small context** (fit ~8k): small batches, no images, merge pass.
...
**Option B — large context** (raise Context Length in LM Studio first, e.g. 32k+):
